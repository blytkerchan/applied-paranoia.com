...
if (-not $allOk) {
    ...
    Write-Host "  - Or use: winget install Ruby InstallerTeam.Ruby (Ruby with DevKit)" -ForegroundColor Yellow
...
Write-Host
Write-Host "Note: For infrastructure setup, see infra\bootstrap" -ForegroundColor Yellow
Write-Host
